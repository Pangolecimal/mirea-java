...
public class MainPanel {
    ...
    MainPanel() {
        ...
        JLabel label2 = new JLabel("Create a new Order?");
        ...
        button4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JLabel label = new JLabel("Really Exit?");
        ...
        button8.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JFrame frame1 = new JFrame("Make the Order");
        ...
        jMenuItem_1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JButton button2 = new JButton("<html>View<br> all orders</html>");
                JButton button3 = new JButton("<html>Total amount of<br>online orders</html>");
                JButton button4 = new JButton("<html>Number of<br>online orders</html>");
                ...
                button2.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (orderManager == null) {
                            label_1.setText("No Order");
                        } else {
                            label_1.setText("Number of internet orders: " + orderManager.getInternetOrders().length);
                        }
                    }
                });
                ...
                button3.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        panel1.setVisible(false);
                        if (orderManager == null) {
                            label_2.setText("No Order");
                        } else {
                            float _temp = orderManager.getTotalInternetOrdersPrice();
                ...
                button5.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        JLabel lb1 = new JLabel("Really delete internet orders?");
